...
trait QueriesRelationships
{
     ...
     * @return \Illuminate\Database\Eloquent\Builder|static
     */
    public function withWhereHas($relation,?callable $callback = null, $operator = '>=', $count = 1)
    {
     ...
     * @return \Illuminate\Database\Eloquent\Builder|static
     */
    public function hasMorph($relation, $types, $operator = '>=', $count = 1, $boolean = 'and',?callable $callback = null)
    {
        if (is_string($relation)) {
            $relation = $this->getRelationWithoutConstraints($relation);
        }
     ...
     * @return \Illuminate\Database\Eloquent\Builder|static
     */
    public function doesntHaveMorph($relation, $types, $boolean = 'and',?callable $callback = null)
    {
     ...
     * @return \Illuminate\Database\Eloquent\Builder|static
     */
    public function whereHasMorph($relation, $types,?callable $callback = null, $operator = '>=', $count = 1)
    {
     ...
     * @return \Illuminate\Database\Eloquent\Builder|static
     */
    public function orWhereHasMorph($relation, $types,?callable $callback = null, $operator = '>=', $count = 1)
    {
     ...
     * @return \Illuminate\Database\Eloquent\Builder|static
     */
    public function whereDoesntHaveMorph($relation, $types,?callable $callback = null)
    {
     ...
     * @return \Illuminate\Database\Eloquent\Builder|static
     */
    public function orWhereDoesntHaveMorph($relation, $types,?callable $callback = null)
    {
